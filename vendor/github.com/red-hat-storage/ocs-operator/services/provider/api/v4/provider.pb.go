...
var file_provider_proto_rawDesc = []byte{
	...
	0x32, 0xf6, 0x06, 0x0a, 0x0b, 0x4f, 0x43, 0x53, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
...
var file_provider_proto_goTypes = []interface{}{
	...
	(*RotateMirroringKeyRequest)(nil),      // 23: provider.RotateMirroringKeyRequest
	(*RotateMirroringKeyResponse)(nil),     // 24: provider.RotateMirroringKeyResponse
...
var file_provider_proto_depIdxs = []int32{
	...
	25, // 2: provider.ClientInfo.clientProfiles:type_name -> provider.ClientInfo.ClientProfilesEntry
	...
	23, // 17: provider.OCSProvider.RotateMirroringKey:input_type -> provider.RotateMirroringKeyRequest
	2,  // 18: provider.OCSProvider.OnboardConsumer:output_type -> provider.OnboardConsumerResponse
	6,  // 19: provider.OCSProvider.GetDesiredClientState:output_type -> provider.GetDesiredClientStateResponse
	8,  // 20: provider.OCSProvider.OffboardConsumer:output_type -> provider.OffboardConsumerResponse
	10, // 21: provider.OCSProvider.ReportStatus:output_type -> provider.ReportStatusResponse
	12, // 22: provider.OCSProvider.PeerStorageCluster:output_type -> provider.PeerStorageClusterResponse
	14, // 23: provider.OCSProvider.RequestMaintenanceMode:output_type -> provider.RequestMaintenanceModeResponse
	18, // 24: provider.OCSProvider.GetStorageClientsInfo:output_type -> provider.StorageClientsInfoResponse
	22, // 25: provider.OCSProvider.GetBlockPoolsInfo:output_type -> provider.BlockPoolsInfoResponse
	24, // 26: provider.OCSProvider.RotateMirroringKey:output_type -> provider.RotateMirroringKeyResponse
